    ...
    <section className="container mb-5 pt-4 pb-2 py-mg-4">
      <div className="row gy-4">
        ...
        <div className="col-lg-9">
          <h2 className="h4">Términos y condiciones</h2>
          <p className="mb-4 pb-2">Atemporal AC</p>
          {/* Video */}
          <div className="gallery mb-4 pb-2" data-video="true">
            <a href="https://www.youtube.com/watch?v=LDb-G8y88Sc" className="gallery-item video-item is-hovered rounded-3">
              <img src="assets/img/home/bg1.jpg" alt="Video preview" />
            </a>
          </div>
          <p className="mb-4 pb-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet consequatur numquam nulla veniam aspernatur, voluptatibus pariatur. Accusantium praesentium magni repellendus incidunt commodi quam quidem quod, pariatur consectetur laboriosam quo qui?</p>
