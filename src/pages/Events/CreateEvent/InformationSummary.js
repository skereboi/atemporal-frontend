          ...
          <div className="border-bottom pb-3 pb-lg-4" onSubmit={handleSubmit(onSubmit)}>
            <div className="row pb-2">
              ...
              <div className="col-sm-12 col-md-6 mb-4">
                <label htmlFor="ciudad" className="form-label fs-base">Ciudad</label>
                <input type="text"
                  id="ciudad" className="form-control form-control-lg"
                  {...register('ciudad')}
                  disabled
                />
              ...
              <div className="col-sm-12 col-md-6 mb-4">
                <label htmlFor="estado" className="form-label fs-base">Estado</label>
                <input type="text"
                  id="estado" className="form-control form-control-lg"
                  {...register('estado')}
                  disabled
                />
